import { Menu, X, Globe, LogIn, LogOut, ChevronDown, PiggyBank, TrendingUp, Languages, Settings, Building2, Briefcase } from 'lucide-react';
    ...
    <>
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-[210] h-14 bg-card border-b border-border flex items-center px-4">
        ...
        <div className="absolute left-0 right-0 flex justify-center items-center gap-2 pointer-events-none">
          ...
          <div>
            <p className="text-sm font-black uppercase tracking-wide leading-tight text-foreground">MyMoneyMate</p>
      ...
      >
        ...
        <div className="border-b border-border">
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground">Portfolio Manager</span>
